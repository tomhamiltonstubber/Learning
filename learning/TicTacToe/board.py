class Gameboard:
    ...
    def check_for_space(self,position,symbol):
        if self.boardlist[int(position)-1] == "X" or self.boardlist[int(position)-1] == "O":
            return False
        else:
    ...
    def print_board(self):
        print("\t" + self.boardlist[0] + self.v + self.boardlist[1] + self.v + self.boardlist[2])
        print("\t" + self.h + self.h + self.h + self.h + self.h)
        print("\t" + self.boardlist[3] + self.v + self.boardlist[4] + self.v + self.boardlist[5])
        print("\t" + self.h + self.h + self.h + self.h + self.h)
        print("\t" + self.boardlist[6] + self.v + self.boardlist[7] + self.v + self.boardlist[8])
        print("")
        
    #Check to see if the game is finished, either the boardlist is full or 3 in a row
