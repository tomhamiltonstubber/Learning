class Gameboard:
    ...
    def print_board(self):
        print("\t" + self._v.join([self.boardlist[0],self.boardlist[1],self.boardlist[2]]))
        print("\t" + self._h + self._h + self._h + self._h + self._h)
        print("\t" + self._v.join([self.boardlist[3],self.boardlist[4],self.boardlist[5]]))
        print("\t" + self._h + self._h + self._h + self._h + self._h)
        print("\t" + self._v.join([self.boardlist[6],self.boardlist[7],self.boardlist[8]]))
        print("")
